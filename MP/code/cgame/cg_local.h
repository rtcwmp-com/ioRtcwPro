...
#include "cg_public.h"
#include "../client/keycodes.h"	// RtcwPro - Demo commands


#define POWERUP_BLINKS      5

#define STATS_FADE_TIME     200.0f // RtcwPro stats
...
qboolean PointVisible(vec3_t point); // RtcwPro shoutcasting
...
int         trap_RealTime( qtime_t *qtime ); // RtcwPro - So it's more accessible
