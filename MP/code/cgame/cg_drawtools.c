...
void CG_DrawTriggers(void) {
	...
	float drawScale = 0;
	int drawEdges = 1, i = 0, j = 0, temp2 = 0;
	float temp;
	...
	for (i = 0; i < cg.drawTriggersCount; ++i)
