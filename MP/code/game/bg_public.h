...
#define GAMEVERSION			"RtcwPro 2.0.0" // this will print on the server and show up as the RtcwPro version
...
#define CS_REINFSEEDS			37
#define CS_PAUSED				38
#define CS_READY				39
#define CS_SVCVAR               40		// RTCWPro - Cvar limiting
#define CS_SERVERTOGGLES        41      // Shows current enable/disabled settings (for voting UI)
#define CS_MATCHID              42    // match id for stats
#define CS_ROUNDINFO            43    // match id for stats
...
// RtcwPro stats dump / weapon stat info: mapping between MOD_ and WP_ types
